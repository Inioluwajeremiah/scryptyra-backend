...
// ─── SVG logo icon ────────────────────────────────────────
const ICON_SVG = `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <rect x="3" y="1" width="11" height="15" rx="2" stroke="white" stroke-width="1.6"/>
  <path d="M6 5.5h5" stroke="white" stroke-width="1.4" stroke-linecap="round"/>
  <path d="M6 8.5h4" stroke="white" stroke-width="1.4" stroke-linecap="round"/>
  <path d="M6 11.5h4.5" stroke="white" stroke-width="1.4" stroke-linecap="round"/>
  <circle cx="15" cy="15" r="4" fill="#ff6b35"/>
  <path d="M13.5 15h3M15 13.5v3" stroke="white" stroke-width="1.4" stroke-linecap="round"/>
</svg>`;
...
.tl-mark{width:36px;height:36px;border-radius:10px;background:linear-gradient(135deg,#ff6b35 0%,#c84010 100%);display:flex;align-items:center;justify-content:center;box-shadow:0 4px 12px rgba(255,107,53,.4);flex-shrink:0}
...
<div class="shell">
  ...
  <div class="topbar">
    <div class="tl">
      <div class="tl-mark">${ICON_SVG}</div>
      <div class="tl-name">SCRY<b>PTY</b>RA</div>
    </div>
    <div class="tr-badge">Screenplay Editor</div>
  </div>
  ...
  <div class="hero">
    ...
    <div class="hero-inner">
      <div class="hero-tag"><div class="hero-dot"></div><span class="hero-lbl">${heroLabel}</span></div>
  ...
  <div class="footer">
    ...
    <p class="f-meta">© ${year} SCRYPTYRA · Open Horizon Innovations. You're receiving this because you have an account at scryptyra.app</p>
  </div>
